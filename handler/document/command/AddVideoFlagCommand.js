...
const {
  insertDocumentFlagValidator,
} = require("../../../validator/DocumentValidator");
...
module.exports.addVideoFlag = async (req, res) => {
  ...
  if (error) {
    await insertLog(
      req,
      "خطا در ثبت برچسب ویدیو",
      `کاربر اطلاعات را درست وارد نکرده`,
      true,
      "سند",
      documentId
    );
  ...
  await insertLog(
    req,
    "ثبت برچسب ویدیو",
    `کاربر بر روی ویدیو ${document.title} برچسب ${description} را وارد کرد`,
    true,
    "سند",
    document._id
  );
