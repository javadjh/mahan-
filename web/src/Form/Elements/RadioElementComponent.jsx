...
const RadioElementComponent = ({option,isDisable,isPreview})=>{
    ...
    let data = {}
    useEffect(()=>{
        data = childrenList.find(c=> c.uiId===option.uiId)?childrenList.find(c=>c.uiId===option.uiId):{}
        ...
        <div className="form-group">
            ...
            <div >
                <Radio.Group >
                    {values.map(v=>(
                        <div>
                            <Radio checked={data.answer?data.answer.includes(v):false}
                                   onClick={()=>{
                                       data.answer = v
                                       data.isValid = true
                                       if(!isPreview)
                                   ...
                                   disabled={isDisable} value={v}>{v}</Radio>
                        </div>
                    ))}
