    ...
    return(
        <MainLayout isMain={true} title={"تست"}>
            ...
            <CanvasDraw
                ref={canvasRef}
                width={"100%"}
                imgSrc={"https://biology.ucdavis.edu/sites/g/files/dgvnsk12066/files/styles/sf_landscape_16x9/public/media/images/20160621_Sunflowers_3385.jpg?h=c673cd1c&itok=AtnPdMM4"}
                style={{
                    width:"100%",
                    boxShadow:
