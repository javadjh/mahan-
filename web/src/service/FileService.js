...
export const getArchiveTreesFileService=(id,filter)=>{
    return axiosConfig.get(`${config.baseUrl}${config.getArchiveTreesFile}${id}`,{
        params:filter
    })
}
...
export const setFileFormService=(fileId,form)=>{
    return axiosConfig.put(`${config.baseUrl}${config.setFileForm}${fileId}`,form)
}


//برای دریافت آمار یک پرونده استفاده می شود
export const getFileStatisticService=(fileId)=>{
    return axiosConfig.get(`${config.baseUrl}${config.getFileStatistic}${fileId}`)
}
...
export const sendFileService=(fileId,message)=>{
    return axiosConfig.put(`${config.baseUrl}${config.sendFile}${fileId}`,message)
}
...
export const rejectFileService=(fileId,message)=>{
    return axiosConfig.put(`${config.baseUrl}${config.rejectFile}${fileId}`,message)
}
...
export const changeFilesArchiveTreeService=(data)=>{
    return axiosConfig.put(`${config.baseUrl}${config.changeFilesArchiveTree}`,data)
}
