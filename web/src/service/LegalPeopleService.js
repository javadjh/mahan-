...
export const insertLegalPersonService=(legalPerson)=>{
    return axiosConfig.post(`${config.baseUrl}${config.insertLegalPerson}`,legalPerson)
}
...
export const updateLegalPersonService=(id,legalPerson)=>{
    return axiosConfig.put(`${config.baseUrl}${config.updateLegalPerson}${id}`,legalPerson)
}
...
export const deleteLegalPersonService=(id)=>{
    return axiosConfig.delete(`${config.baseUrl}${config.deleteLegalPerson}${id}`)
}
...
export const insertLegalPeopleFormExcelService=(file)=>{
    return axiosConfig.post(`${config.baseUrl}${config.insertLegalPeopleFormExcel}`,file)
}
