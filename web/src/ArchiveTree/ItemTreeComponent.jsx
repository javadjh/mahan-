...
const ItemTreeComponent = ({ isMain, mainParent }) => {
  ...
  let renderHTML = (
    <ItemTreeComponent mainParent={mainParentItem} isMain={false} />
  );
  useEffect(() => {
    getData();
  }, []);
      ...
      <div style={{ marginRight: 20, backgroundColor: "#e7e7e7" }}>
        ...
        <div className={"row m-0 p-0"}>
          ...
          <div className={"col-lg-12 row pr-0 pl-1"}>
            ...
            <div
              className={" mx-0 p-0 ml-2"}
              style={{ width: "100%", marginBottom: 10 }}
            >
              <span style={{ cursor: "pointer" }} className={"row mx-2"}>
                <div
                  style={{
                    display: "flex",
  ...
  /* <ContextMenuTrigger id="archiveTreeRightClick">
                    <span
                      onClick={() => {
                        ...
                        if (d.isMain) setMainArchiveTree(d);
                      }}
                    ...
                    >
                      ...
                      >
                        <div className={"row "}>
                          ...
                          <span
                            className={"m-0 p-0"}
                            style={{ color: "#414141", marginTop: -10 }}
                          >
                            {d.title} ({d.totalFileCount})
                          </span>
                        </div>
                        <span
                          hidden={
                            handleHide("انتخاب فرم برای بایگانی") ||
                            handleHide("ثبت اطلاعات تکمیلی برای بایگانی")
                          }
                        >
                          {/*<i onClick={()=>{
