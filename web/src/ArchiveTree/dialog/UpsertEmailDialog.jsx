...
import {
  insertEmailAction,
  updateEmailAction,
} from "../../stateManager/actions/EmailAction";
        ...
        <div className="modal-dialog modal-lg" role="document">
          <div className="modal-content p-4">
              ...
              <div className="button-items">
                ...
                {usersReceiver.map((u) => (
                  <button
                    ...
                    className={
                      "btn btn-info waves-effect waves-light ml-0 mr-1 mt-0"
                    }
                  >
                    {u.userName}
                  </button>
            ...
            <div className={"row mx-1"}>
              ...
              <button
                onClick={sendData}
                className={"btn btn-success mt-3 col-lg-3"}
              >
                ثبت
              </button>
            </div>
