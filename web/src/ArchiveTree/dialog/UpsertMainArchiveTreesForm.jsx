...
const UpsertMainArchiveTreesForm = ({currentArchiveTree})=>{
    ...
    return(
        <Fragment>
            ...
            <div className="modal fade bs-example-modal-xl" id="upsertMainArchiveTreesForm" tabIndex="-1" role="dialog"
                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-xl" role="document">
                    <div className="modal-content p-4">
                        <div className={"card card-body px-4"}>
                            <h5 className={"mb-0 mt-3"}>انتخاب روکش اسناد زیر مجموعه</h5>
                            <div>
                                ...
                                <div className={"row"}>
                                    ...
                                    <div className={"col-lg-3"} onClick={ async ()=>{
                                        await dispatch(mainArchiveTreesFormAction(currentArchiveTree._id,
                                            {formSelected:form,isFormRequired}))
                                    }}>
...
export default UpsertMainArchiveTreesForm
