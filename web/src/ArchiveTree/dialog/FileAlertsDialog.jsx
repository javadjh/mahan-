...
const FileAlertsDialog = ()=>{
    ...
    return(
        <Fragment>
            <div className="modal fade" id="fileAlertsDialog" tabIndex="-1" role="dialog"
                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content p-4">
                        <div>
                            <div >
                                <p>میتوانید با استفاده از فرم زیر برای پرونده هشدار ایجاد کنید تا بقیه کاربران از هشدار های مربوط به این پرونده مطلع باشند</p>
                                <div className="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder={"عنوان هشدار را وارد کنید..."} required/>
                                    {formValidator.current.message("alertTitle",alertTitle,"required|min:2|max:255")}
                                </div>
                                <div className="form-group">
                                    ...
                                    <textarea
                                        ...
                                        className="form-control" id="validationCustom04"
                                        placeholder={"توضیحات هشدار را وارد کنید..."} required/>
                                    {formValidator.current.message("alertDescription",alertDescription,"required|min:2|max:1000")}
                                </div>
                                <div className="form-group">
                                    <label htmlFor="validationCustom04">تاریخ انقضا</label>
                                    <PersianDatePickerComponent value={alertDate} onSelect={(moment)=>{
                                ...
                                <div className={"row"}>
                                    ...
                                    <div className={"col-lg-3"}>
                                        <button onClick={insertFileAlertHandle} className={"btn btn-success btn-block mb-2"}>ثبت</button>
                                    </div>
                                </div>
                            </div>
                            {/*<span className={"mt-3"}>
