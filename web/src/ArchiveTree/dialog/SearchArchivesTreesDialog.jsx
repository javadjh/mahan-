...
const SearchArchivesTreesAction = ({moveToNewArchiveTree})=>{
    ...
    const getData = async ()=>{
        if(archiveId)
            await dispatch(searchArchivesTreesAction({
                archiveId,
                searchValue
            }))
    }
    ...
    return(
        <Fragment>
            <div className="modal fade" id="searchArchivesTrees" tabIndex="-1" role="dialog"
                    ...
                    <div className="modal-content p-4">
                        <div>
                            ...
                            <select className="custom-select" onChange={(e)=>{
                                ...
                                {usersArchives.map(u=>(
                                    <option value={u.archiveId._id} name={u.archiveId._id}>{u.archiveId.title}</option>
                                ))}
                            ...
                            <div className="form-group">
                                ...
                                <input type="text"
                                       ...
                                       placeholder="عنوان قفسه را وارد کنید..." required/>
                            </div>
                            ...
                            {archiveTree._id?(
                                ...
                                }}>انتقال به {archiveTree.title}</button>
                            ):null}
                        </div>
                    </div>
                </div>
