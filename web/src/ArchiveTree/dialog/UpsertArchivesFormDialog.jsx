                ...
                if(formState.file){
                    if(formState.file.form){
                        if(formState.file.form.length===0){
                            if(fileForm){
                                if(fileForm.form)
                                    if(fileForm.form.children)
                                        setForm(fileForm.form.children)
                            }
...
{/*                        <h6>{fileForm.form.title}</h6>
                                ...
                                <>
                                    {c.type==="input"?(
                                        <div className={"col-lg-6"}>
                                            <InputElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                    {c.type==="checkBox"?(
                                        <div className={"col-lg-6"}>
                                            <CheckElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                    {c.type==="radio"?(
                                        <div className={"col-lg-6"}>
                                            <RadioElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                    {c.type==="selector"?(
                                        <div className={"col-lg-6"}>
                                            <SelectorElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                    {c.type==="textArea"?(
                                        <div className={"col-lg-6"}>
                                            <TextAreaElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                    {c.type==="date"?(
                                        <div className={"col-lg-6"}>
                                            <DateElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                    {c.type==="dateMiladi"?(
                                        <div className={"col-lg-6"}>
                                            <DateMiladiElementComponent option={c} isDisable={handleHide("ویرایش روکش پرونده")} isPreview={isPreview}/>
                                        </div>
                                    ):null}
                                </>
                            )):null}
                        ...
                        {!isPreview?(
                            <button
                                ...
                                onClick={sendData}
                                className={"btn btn-success btn-block col-lg-2"}>ثبت</button>
                        ):null}
                    </div>
                </div>
            </div>
