      ...
      {searchArchiveTrees.map((s) => (
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <a style={{ fontSize: 14, alignSelf: "center", marginRight: 5 }}>
              {s.route}
            </a>
            <div
              style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              ...
              >
                <div className={"row mx-1"}>
                  <img
                    src={"./assets/images/archiveroom.png"}
                    width={20}
                    height={20}
                    style={{ marginTop: 5, marginLeft: 10 }}
                  />
                  <p className={"m-0 p-0"} style={{ color: "#414141" }}>
                    {u.archiveId.title}
                  </p>
                </div>
              </div>
            ...
            >
              <i
                ...
                style={{ fontSize: 19, color: "orange" }}
              />
            </span>
          </div>
