...
const InsertFileComponent = ({ tree, mainTree }) => {
  ...
  //   const { tree, setIsShowAddFile, mainArchiveTree } = useContext(
  ...
  const sendData = async (formData) => {
    formData.fileDate = tree.lang === "fa" ? formData.faDate : formData.enDate;
                ...
                <Col span={8} dir={"ltr"}>
                  <Row align="middle">
                    {tree.archive.availablePattern === "five" ? null : (
                      <Col span={8}>
                        {tree.archive.availablePattern === "two"
                          ? `${tree.archive.firstStringOfPattern}-${moment1(
                              new Date(),
                              "YYYY/MM/DD"
                            )
                              .locale("fa")
