import {fileAlertsService, insertFileAlertService} from "../../service/FileAlertService";
import {doneToast} from "../../utility/ShowToast";
import {getUsersFileAlertsService, getUsersFilesAlertsService} from "../../service/UsersService";


//ثبت هشدار برای پرونده
export const insertFileAlertAction = (fileAlert,setAlertTitle,setAlertDescription,setAlertDate)=>{
