...
import {
    ...
    deleteLibrariesDocumentService, deleteLibraryShelfService,
    getLibraryService, getLibraryShelfDocumentsService,
    insertLibraryShelfService, moveDocumentsToLibraryShelfService, updateLibraryShelfService
} from "../../service/LibraryService";
import {doneToast} from "../../utility/ShowToast";


//برای حذف سندی که در کازیو میباشد
export const deleteLibrariesDocumentAction = (id,libraryShelfId,setReload)=>{
