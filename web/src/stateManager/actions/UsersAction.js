import {
    changePasswordService, changeUsersPasswordAdminService, checkUsersTokenService,
    deleteUserService, getAdminDashboardService,
    getAllUsersService, getArchivesSupervisorsService, getSupervisorsService, getUsersArchivesService,
    insertUserService, loginService, setUsersProfileImageService, updateProfileService, updateUserService,
    upsertUserDataService, userForgetPasswordService, usersAutocompleteService, usersProfileService
...
export const changePasswordAction = (passwordData,setOldPassword, setNewPassword)=>{
    return async (dispatch)=>{
