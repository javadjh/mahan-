        ...
        <table id="tech-companies-1" className="table table-striped">
          <thead>
            <tr>
              ...
              <th hidden={handleHide("تعریف کاربر")} data-priority="6">
                عملیات
              </th>
            </tr>
          </thead>
              ...
              <tr>
                ...
                <td hidden={handleHide("تعریف کاربر")}>
                  <div
                    className="btn-group"
                    hidden={
                      u.position === "مدیر سامانه" ||
                      u.position === "توسعه دهنده"
                    }
                  >
                    <div className="btn-group dropright">
                      ...
                      <div className="dropdown-menu">
                        ...
                        <a
                          className="dropdown-item"
                          onClick={() => onOpenAlertDialogHandle(u)}
                        >
                          حذف
                        </a>
                        <a
                          className="dropdown-item"
                          onClick={() => changeUsersPasswordAdminHandler(u)}
                        >
                          تغییر کلمه عبور
                        </a>
                      </div>
